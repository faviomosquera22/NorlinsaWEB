...
import { BarChart3, BookOpenCheck, ChevronDown, CircleDollarSign, Database, FileClock, FileText, Menu, ReceiptText, Settings, Truck, WalletCards, X } from "lucide-react";
